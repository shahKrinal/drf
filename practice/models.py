...
ROLE = (('finance', 'finance'), ('accountant', 'Accountant'), ('HR', 'HR'))
User_types = ((1, 'System_Admin'), (2, 'System_staff'), (3, 'CLIENT_ADMIN'), (4, 'CLIENT_STAFF'),
              (5, 'CLIENT_PREMIUM_STAFF'))


class Permissions(models.Model):
    permission = models.TextField(max_length=500)
